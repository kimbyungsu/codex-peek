...
export const BRIDGE_SCRIPTS = ["contract-lib.js", "verify-cap-handoff.js", "codex-bridge.js", "ask-job-worker.js", "codex-hook.js", "codex-plugin-install.js", "contract-inject.js", "verify-guard.js", "codex-guard.js", "deepseek-bridge.js", "scout-gate.js", "project-map.js", "map-runtime.js", "map-bootstrap.js", "map-pipeline.js", "map-bindings.js", "map-adapters.js", "map-freshness.js", "map-reader.js", "map-retrieval.js", "map-provenance.js", "map-cutover.js", "map-probe.js", "map-probe-batch.js", "map-router.js", "map-enrich.js", "map-intent.js", "enrich-providers.js", "enrich-calls.js", "enrich-excerpt-cfg.js", "evidence-challenge.js", "citation-check.js", "map-rotation.js", "rules-flow.js", "curation.js", "selector-runner.js", "preview-gate.js", "session-start.js", "scout-providers.js", "scope-package.js", "scout-store.js", "scope-scout-self.js", "scope-scout-deepseek.js", "scope-scout-codex.js", "scope-target.js", "scope-gate.js", "scope-map.js", "scope-ledger-migrate.js", "scope-ledger-backfill.js", "scope-ledger-note.js", "scope-package-core.js", "scope-ledger-core.js", "ledger-events-core.js"]; // [정찰 층 이관 2026-09-16] scripts/ 정찰 실행층 12+코어 사본 3 — 마켓 설치본만으로 3트랙 · ask-job-worker=내구 검증, codex-hook=Codex 구현자 lifecycle. 뒤 MAP 파일=P0.5/P1/P4/P8/P9 런타임(map-adapters→map-reader→map-freshness require 사슬 — P3b 배포 편입). selector-runner/preview-gate=[Envelope Selector 3a·4b]
...
// 명령 하나가 "우리 훅"인가 — install.js isOurHookCmd와 동일 규칙(경로 경계 매칭, 부분문자열 오탐 방지).
