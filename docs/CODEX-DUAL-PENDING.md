...
- 착수 순서는 **HANDOFF §1-0 끝의 '다음 순서'가 정본(2026-07-16 갱신)**: ~~P-8 1단~~(완료 07-15) →
  ~~P-5~~(완료 07-15) → ~~검증 스위치 분리+P-10~~(완료 07-16 ae9932b) → ~~P-9 자동 전환+done 종결~~(완료
  07-16 1d31617) → P-2(PRIVACY)·P-3(TTL)·P-4(손상 job) 잔여(P-1 해결 07-15) → P-8 2단 잔여(v10 나머지 —
  잠금 축은 분리 묶음에서 선반영)·fallback↔훅 경합 → P-6b 서술 정정. (이 단락의 옛 참조 'HANDOFF §깃헙 동기화 절 07-14 14:02'와 'P-6·P-5 같은 묶음 권장'은
