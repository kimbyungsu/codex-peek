...
> 마지막 갱신: 2026-07-18 (버전 0.1.86 불변 · 이 갱신을 포함해 push된 main 기준). **이번 push 묶음(11커밋) 요지 — 캐논 v2.3·v2.4+P-12 2b 왕복 상한 완결(2단 잔여 2c·2d)**:
