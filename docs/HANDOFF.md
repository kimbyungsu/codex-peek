...
> 마지막 갱신: 2026-07-18 (버전 0.1.86 불변 · 이 갱신을 포함해 push된 main 기준). **이번 push 묶음(12커밋 — ★후속 정정: 원표기 11은 자기 서술 커밋 d154a83 제외 집계였음, d154a83에는 테스트 단언 추가도 동승했으므로 12가 정확) 요지 — 캐논 v2.3·v2.4+P-12 2b 왕복 상한 완결(2단 잔여 2c·2d)**:
