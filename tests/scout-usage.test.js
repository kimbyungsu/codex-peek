...
// D-2026-09-19-bridge-stale-banner: '손상' 단정 문구 폐기 — 재로드 전(옛 판독기)과 실제 판독 실패를 갈라 말한다
ok(/자동 보강 기록을 읽지 못했어요\(손상 여부 확인이 필요해요\)/.test(ext) && /이 창의 판독기가 이전 판이라 자동 보강 기록을 읽지 못해요/.test(ext), "판독 실패 상태를 미시작과 구분해 표시(옛 판독기/손상 확인 두 갈래)");
{
