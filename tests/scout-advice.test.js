...
store.saveMap(repo, "self", "# 지도2\n① 직접 변경 후보\n- a.md — high", { seedFiles: ["a.md"] }); // 새 지도 → 서명 리셋
...
store.saveMap(repo, "self", "# 지도4\n① 직접 변경 후보\n- a.md — high", { seedFiles: ["a.md", "b.md", "c.md", "d.md"] });
