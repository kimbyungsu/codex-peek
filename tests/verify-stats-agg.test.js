...
ok(cs(J({ ts: ago(3), workspace: "/ws", verdict: "pass" }), null).byModel["(unknown)"].count === 1, "model/mode 없는 과거 기록은 (unknown)");
...
ok(computeProjectStats(J({ ts: ago(3), verdict: "pass" }), NOW, normWs)["(unknown)"].count === 1, "workspace 없으면 (unknown) 그룹");
