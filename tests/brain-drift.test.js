...
const DRIFT_FRESH_MS = 24 * 60 * 60 * 1000;
...
ok(lastModelFresh([{ cwd: "D:\\A", model: "claude-fable-5", timestamp: oldTs }], "D:\\A", NOW, DRIFT_FRESH_MS) === "", "신선도: 19일 전 fable 마지막답 → stale 제외(거짓 fable 경고 차단)");
