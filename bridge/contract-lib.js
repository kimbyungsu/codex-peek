...
function buildSelectorPagePrompt({ snapshotText, changedFiles, diffText, pageItems }) {
  ...
  if (typeof diffText === "string" && diffText) { L.push("", "[변경 내용(유계 절단)]", diffText.slice(0, 20000)); }
  L.push("", "[승인 수칙 후보 페이지]");
